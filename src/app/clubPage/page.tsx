                            ...
                            <Card.Body>
                                ...
                                <div className="club-info">
                                    <Card.Text className="club-details">
                                        <strong>Navn:</strong> Bø Discgolf{" "}
                                        <br />
                                        <strong>Sted:</strong> Bø, Telemark,
                                        Norge <br />
                                        <strong>Medlemmer:</strong> 70 <br />
                                        <br />
                                        Den største discgolfklubben i Telemark.{" "}
                                        <br />
                                        <button
                                            type="button"
                        ...
                        <Card.Body>
                            ...
                            <div className="courses">
                                <div className="course">
                                    ...
                                    <p>
                                        <strong>Adresse:</strong> Campus Bø, Bø{" "}
                                        <br />
                                        <strong>Hull:</strong> 18 <br />
                                        <strong>Vanskelighetsgrad:</strong>{" "}
                                        Middels <br />
                                        <strong>Beskrivelse:</strong> En
                                        utfordrende bane for både nybegynnere og
                                        erfarne spillere, omgitt av fin natur.
                                        <br />
                                        ...
                                        <br />
                                        <strong>Beste score: </strong> 42 kast
                                        av Ben Dover <br />
                                        <button
                                            type="button"
                                            className="buttonMore"
                                ...
                                <div className="course">
                                    <h5>Grivihaugen</h5>
                                    <p>
                                        <strong>Adresse:</strong> Grivibakken 2,
                                        Bø <br />
                                        <strong>Hull:</strong> 9 <br />
                                        <strong>
                                            Vanskelighetsgrad:
                                        </strong> Lett <br />
                                        <strong>Beskrivelse:</strong> Perfekt
                                        for nybegynnere og korte treningsøkter.{" "}
                                        <br />
                                        <strong>Værprognose:</strong>{" "}
                                        {weatherData ? (
                                            `${weatherData.main.temp}°C, ${weatherData.weather[0].description}`
                                        ...
                                        <br />
                                        <strong>Beste score: </strong> 17 kast
                                        av DiscgolfMaster123 <br />
                                        <button
                                            type="button"
                                            className="buttonMore"
                                        >
