                ...
                <section>
                    <div className="row">
                        <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                            <h6 className="text-uppercase mb-4 font-weight-bold">TeeTime</h6>
                            <hr
                                className="mb-4 mt-0 d-inline-block mx-auto bg-light"
                                style={{width: "60px", height: "2px"}}
                            />
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae itaque tempora inventore ratione non quod!</p>
                        </div>
                        ...
                        <div className="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
                            ...
                            <p><a className="text-white">Register Now!</a></p>
                        ...
                        <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                            ...
                            <hr
                                ...
                                style={{width: "60px", height: "2px"}}
                            />
                            <p><i className="fas fa-home mr-3"></i> Gullbringvegen 28, Bø 3800, NOR</p>
                            <p><i className="fas fa-envelope mr-3"></i> info@gmail.com</p>
                            <p><i className="fas fa-phone mr-3"></i> + 47 123 456 78</p>
                        </div>
                    </div>
                </section>
                <hr className="my-3" />
